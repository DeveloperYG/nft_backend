...
try{
    var sql = `SELECT name,slug,count FROM nft_stats ORDER BY one_day_volume  DESC LIMIT 10 `;
    ...
    //    var end = Math.ceil(e.count/ 50);
       ...
       for (i = 0; i < end; i++) {
         ...
         try{
                ...
                try{
                  axios.request(options).then(function (response) {
                    response.data.data.forEach(item=>{
                      ...
                      // console.log(data)
                      try{
                        sql = `INSERT INTO assets5 ( collection_name,collection_image,asset_name,image_url,owner,price,trait_type,trait_value,trait_count,rarity_percentage,rarity_scores,rarity) VALUES ("${
                            e.name
               ...
               }catch(e){console.log("Not present")}
           
         }catch(error){"api request",console.log("Not present")}
